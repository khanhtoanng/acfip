...
namespace ACFIP.Data.Migrations
{
    ...
    [Migration("20210312004316_updateModel")]
            ...
            modelBuilder.Entity("ACFIP.Data.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DeletedFlag = false,
                            HashedPassword = "TdavOrKGmKVFNCPb7dkf8xcGHfzaGO4sni/tplKUmg2HTrr8fgzgnXKy43KtTBHRlYlY57NeY2jgfZ3YjDXc3g==",
                            IsActive = true,
                            RoleId = 1,
                            Salt = new byte[] { 52, 183, 119, 5, 125, 143, 146, 55, 29, 174, 10, 114, 101, 70, 46, 160 }
                        });
                });
