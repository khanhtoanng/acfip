...
namespace ACFIP.Data.Migrations
{
    ...
    [Migration("20210330151644_filenameViolation")]
    partial class filenameViolation
    {
            ...
            modelBuilder.Entity("ACFIP.Data.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DeletedFlag = false,
                            HashedPassword = "49JGuFxSp3/76V8i56Wrd6mai9PnFugGWvSV8MvWCMawrEkwooYrApn2NaQKuRZtOosfemHHFowIgQza5NNmwA==",
                            IsActive = true,
                            RoleId = 1,
                            Salt = new byte[] { 123, 51, 103, 81, 24, 167, 28, 136, 191, 254, 133, 116, 204, 240, 137, 124 }
                        });
                });
