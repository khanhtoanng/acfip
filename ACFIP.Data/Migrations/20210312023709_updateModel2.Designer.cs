...
namespace ACFIP.Data.Migrations
{
    ...
    [Migration("20210312023709_updateModel2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ACFIP.Data.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DeletedFlag = false,
                            HashedPassword = "rCxHB0X4qSfqQvOSoOFdDYG+lAja60erll5f6XbQS6uj+JvC1RjiG/GmrBuIiZQ9f4ysehn4kGgu+7XLasNL7w==",
                            IsActive = true,
                            RoleId = 1,
                            Salt = new byte[] { 68, 19, 139, 238, 196, 132, 63, 113, 147, 243, 218, 157, 239, 130, 197, 233 }
                        });
                });
            ...
            modelBuilder.Entity("ACFIP.Data.Models.GroupCamera", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
            ...
            modelBuilder.Entity("ACFIP.Data.Models.Camera", b =>
                {
                    ...
                    b.HasOne("ACFIP.Data.Models.GroupCamera", "GroupCamera")
                        .WithMany("Cameras")
