...
namespace ACFIP.Data.Migrations
{
    ...
    [Migration("20210312010236_updateModel1")]
            ...
            modelBuilder.Entity("ACFIP.Data.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DeletedFlag = false,
                            HashedPassword = "8nDX2MFZtW8oCZozAhWVZNkOa1Wld1vYA5TeSUOe/0jBNv/oi47nP3P9J3TTvBWBLT1riAt0GwGtm5+vXIGpsQ==",
                            IsActive = true,
                            RoleId = 1,
                            Salt = new byte[] { 3, 138, 227, 147, 107, 157, 69, 85, 110, 185, 122, 116, 172, 213, 194, 4 }
                        });
                });
