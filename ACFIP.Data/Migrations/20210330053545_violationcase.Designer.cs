...
namespace ACFIP.Data.Migrations
{
    ...
    [Migration("20210330053545_violationcase")]
    partial class violationcase
    {
            ...
            modelBuilder.Entity("ACFIP.Data.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DeletedFlag = false,
                            HashedPassword = "qtb8IAO8A5OSqyGzRwyKDMWNxBTEaGvRoBqzuLhAYo/lpekWLUvlyLtqWnPurgdmlBp58y/YqPEXgZKN9Fi49w==",
                            IsActive = true,
                            RoleId = 1,
                            Salt = new byte[] { 38, 100, 35, 238, 127, 157, 210, 186, 166, 111, 187, 225, 38, 75, 237, 21 }
                        });
                });
