...
namespace Project.Controller
{
    ...
    public class ViolationController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<IActionResult> GetAllViolation([FromQuery] PagingRequestParam param)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> CreateViolation(ViolationRequestParam param)
        {
            try
            {
