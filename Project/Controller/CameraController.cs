...
namespace Project.Controller
{
    ...
    public class CameraController : ControllerBase
    {
        ...
        [HttpPut]
        public async Task<IActionResult> Update([FromBody] CameraRequestParam param)
        {
            try
            {
        ...
        [HttpPost]
        public async Task<IActionResult> CreateAccount([FromBody] CameraRequestParam param)
        {
            try
            {
